...
export default function Header() {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      {/* Desktop menu */}
      <nav aria-label="Global" className="flex items-center justify-between p-12 border-b">
          ...
          {socialLinks.map((social, idx) => {
            ...
            return (
              <a
                ...
                className={`flex items-center text-white${idx !== 0 ? ' ml-4' : ''}`}
              >
                ...
                {socialLinks.map((social, idx) => {
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`flex items-center text-white${idx !== 0 ? ' mt-2' : ''}`}
                    >
                      <Icon className="h-6 w-6" />
                      <span className="ml-2">{social.name}</span>
                    </a>
